...
function whyItMatters(f) {
  ...
  if (id.startsWith('ENTRA-SSPR')) return 'The MFA Registration Campaign nudges users at sign-in to install Microsoft Authenticator, accelerating phishing-resistant MFA adoption across the tenant. Enabling for all users converts passive rollout into active rollout. (Note: Microsoft historically nested this setting under SSPR policy for legacy reasons; functionally it is an MFA enrollment control, not password reset.)';
